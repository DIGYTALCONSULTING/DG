...
<div
  ...
  >
    ...
    <div
      class="h-[450px] w-[650px] bg-repeat
    ...
    >
      <!-- Email -->
      <div class="flex flex-col w-full max-w-sm h-8">
        <input
          v-model="email"
          type="email"
          id="email"
      ...
      <button
        @click="submitForm"
        :disabled="!agreed"
        class="mt-2 px-2 py-2 !bg-[#FF7A00] hover:!bg-[#E56A00] text-[#FFFFFF] font-bold rounded
